 ...
 */
static void body(unsigned char *data, unsigned int size, ARCH_WORD_32 *result)
{
	unsigned char *ptr;
	MD5_u32plus a, b, c, d;
 ...
 */
void MD5_Go(unsigned char *data, int len, unsigned char *result)
{
	...
	body(data, process,(ARCH_WORD_32 *)result);
        ...
        memcpy(result,MD5_bitswapped_out[3],16);
#else 
//        memcpy(result,MD5_out,16);
#endif
}
