/*
   ...
   Modified by Matt Weir <weir@cs.fsu.edu>
*/
...
void Usage()
{
	...
	printf("usage: drcrack rainbow_table_pathname -h hash\n");
	printf("       drcrack rainbow_table_pathname -l hash_list_file\n");
	printf("       drcrack rainbow_table_pathname -f pwdump_file\n");
	printf("       --To use a dictionary based rainbow table--------\n");
	printf("       drcrack -d rainbow_table_pathname -h hash\n");
	printf("       drcrack -d rainbow_table_pathname -l hash_list_file\n");
        printf("       drcrack -d rainbow_table_pathname -f pwdump_file\n");
	...
	printf("-d 			use a dictionary based attack\n");
	printf("\n");
	printf("example: drcrack *.rt -h 5d41402abc4b2a76b9719d911017c592\n");
	printf("         drcrack *.rt -l hash.txt\n");
	printf("         drcrack *.rt -f hash.txt\n");
	printf("         drcrack -d *.rt -l hash.txt\n");
}
...
int main(int argc, char* argv[])
{
	...
	if (argc != 4)
	{
	  ...
	  string sInput            = argv[3];
          ...
          string sWildCharPathName = argv[2];
          string sInputType        = argv[3];
          string sInput            = argv[4];
          isDictionary=true;
        }
	...
	vector<string> vNTLMHash;	// ntlm cracker
	if (sInputType == "-h")
	{
		fCrackerType = true;
